...
🔗 [Paper](http://arxiv.org/abs/2607.08763v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08763v1)
...
🔗 [Paper](http://arxiv.org/abs/2607.08758v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08758v1)
...
🔗 [Paper](http://arxiv.org/abs/2607.08745v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08745v1)
...
🔗 [Paper](http://arxiv.org/abs/2607.08740v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08740v1)
...
🔗 [Paper](http://arxiv.org/abs/2607.08734v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08734v1)
...
🔗 [Paper](http://arxiv.org/abs/2607.08731v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08731v1)
...
🔗 [Paper](http://arxiv.org/abs/2607.08725v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08725v1)
...
🔗 [Paper](http://arxiv.org/abs/2607.08716v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08716v1)
...
🔗 [Paper](http://arxiv.org/abs/2607.08691v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08691v1)
...
🔗 [Paper](http://arxiv.org/abs/2607.08690v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08690v1)
...
🔗 [Paper](http://arxiv.org/abs/2607.08662v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08662v1)
...
🔗 [Paper](http://arxiv.org/abs/2607.08652v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08652v1)
...
**Authors:** Ali Larian, Qian Lin, Chang Zong Wu, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08647v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08647v1)
...
**Authors:** Xinlong Zhao, Dongsheng Liu, Hengyu Zhao, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08646v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08646v1)
...
**Authors:** João Matos, Olivia Buege, Donny Cheung, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08625v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08625v1)
...
🔗 [Paper](http://arxiv.org/abs/2607.08605v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08605v1)
...
### 21. Towards Precision Therapy in Hepatocellular Carcinoma: A Clinical-Reasoning LLM for Risk Stratification and Treatment Guidance

**Authors:** Peng Cui, Jitao Wang, Siyan Xue, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08602v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08602v1)
...
### 22. SHAP-Weighted Cross-Modal Expert Fusion for Emotion and Sentiment Recognition: Evidence and Limits

**Authors:** Adis Alihodzic, Selma Skopljakovic Hubljar

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08573v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08573v1)
...
### 23. SMetric: Rethink LLM Scheduling for Serving Agents with Balanced Session-centric Scheduling

**Authors:** Jiahao Wang, Kaizhan Lin, Kaixi Zhang, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08565v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08565v1)

**Summary:** LLM scheduling is critical to serving, yet it remains unclear how well existing designs fit agentic serving--with LLM requests issued by agents instead of humans. This shifts the workload in two ways: (1) agents act only on complete responses, making the cluster's tokens per second (TPS) the primary goal and relaxing--not eliminating--per-token latency requirements; and (2) requests share much of their KV\$-reuse exceeds 80% of request tokens in a production trace from BAILIAN, versus 54-62% in ...

---

### 24. CommuniWave:A Machine Learning Model for Quantifying the Degree of Temporary Informal Behavior in Urban Communities

**Authors:** Hongye Yang, Shien Liu, Zhihao Xie

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08554v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08554v1)

**Summary:** For urban managers and designers, improving the functional attributes of urban communities to enhance territorial resilience in the face of complexity and uncertainty is crucial. Currently, community planning often follows a top-down approach and lacks effective metrics to quantify informal behaviors of residents, leading to frequent conflicts with original plans. This study introduces CommuniWave, a machine learning model designed to efficiently detect and quantify the Degree of Informal Behavi...

---

### 25. VocaDet: Sample-Driven Open-Vocabulary Object Detection and Segmentation via Visual Tokenization and Vector Database Retrieval

**Authors:** ZhiXin Sun

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08541v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08541v1)

**Summary:** Open-vocabulary object detection and segmentation aim to recognize arbitrary objects beyond predefined categories. Although recent vision-language and reference-based approaches have significantly advanced this field, they often rely on text prompts, limited visual examples, or expensive feature matching procedures, making them difficult to scale to large and continuously expanding object repositories. In this work, we propose VocaDet, a sample-driven open-vocabulary object detection and segment...

---

### 26. DocMaster: A Hierarchical Structure-Aware System for Document Analysis

**Authors:** Ziqi Chen, Yingli Zhou, Fangyuan Zhang, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08539v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08539v1)
...
### 27. When the Judge Changes, So Does the Measurement: Auditing LLM-as-Judge Reliability

**Authors:** Zongyou Yang, Yinghan Hou, Xiaokun Yang

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08535v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08535v1)
...
### 28. AI-guided stimuli discovery and generation to optimize facial emotion perception studies in autism

**Authors:** Kushin Mukherjee, Na Yeon Kim, Maren Wehrheim, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08533v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08533v1)

**Summary:** Understanding perceptual differences between autistic and neurotypical adults requires behavioral assays that are sensitive, reliable, and mechanistically informative. Facial emotion perception is a useful test case because group differences have been reported, but findings vary across studies. Here we show that this variability may reflect image-level sparsity: autistic-neurotypical differences in emotion judgments were concentrated in a small subset of diagnostic facial expressions rather than...

---

### 29. Cognitive-structured Multimodal Agent for Multimodal Understanding, Generation, and Editing

**Authors:** Feng Wang, Canmiao Fu, Zhipeng Huang, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08497v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08497v1)
...
🔗 [Paper](http://arxiv.org/abs/2607.08490v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08490v1)

**Summary:** Biomedical language evolves rapidly as new discoveries emerge, causing traditional text models to lose semantic fidelity over time. Static embeddings and co-occurrence graphs cannot capture such evolution, leading to performance degradation in retrieval and knowledge discovery tasks. This paper introduces a Drift-Aware Temporal Graph Rewiring (DATGR) framework that models concept evolution by dynamically updating co-occurrence edges based on estimated semantic drift. Instead of retraining embedd...

---

### 32. VEGAS: Human-Aligned Video Caption Evaluation via Gaze

**Authors:** Shenghui Chen, Po-han Li, Ximeng Sun, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08489v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08489v1)
...
### 33. Applying JEPA-Style Predictive Learning to JA4-Derived Network Fingerprints

**Authors:** Javier Izquierdo, Aygul Zagidullina

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08465v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08465v1)
...
### 34. Two Axes of LLM Abstention: Answer Correctness and Question Answerability

**Authors:** Benedikt J. Wagner

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08456v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08456v1)

**Summary:** A model should refuse two different things: answers it would get wrong, and questions it should not answer at all, such as unanswerable ones or ones resting on a false premise. The usual recipe thresholds a single confidence score, which cannot tell these apart. Across five instruction-tuned models from three families (2B to 14B), we find they are separate axes. Ordinary answer-confidence tracks whether an answer is right but is nearly blind to whether the question is answerable; a linear probe ...

---

### 35. Spatio-Temporal Scheduling Prediction Under Backhaul Delay for Resilient Coordinated Beamforming

**Authors:** Prashant Kumar Singh, Shubham Vaishnav, Ahmet Hasim Gökceoglu, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08454v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08454v1)
...
🔗 [Paper](http://arxiv.org/abs/2607.08409v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08409v1)
...
### 46. WCog-VLA: A Dual-Level World-Cognitive Vision-Language-Action Model for End-to-End Autonomous Driving

**Authors:** Xuerun Yan, Zhexi Lian, Nuoheng Zhang, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08375v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08375v1)
...
### 47. Large-Language-Models-as-a-Judge in Theory-Agnostic Adaptive Metric-Alignment for Prototypical Networks in Personality Recognition

**Authors:** Jing Jie Tan, Ban-Hoe Kwan, Danny Wee-Kiat Ng, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08374v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08374v1)
...
### 48. Self-Adaptive Anomaly Detection with Reinforcement Learning and Human Feedback in Connected Vehicles

**Authors:** Matthias Weiß, Athreya Hosahalli Prakash, Maurice Artelt, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08373v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08373v1)

**Summary:** Connected vehicles are autonomous cyber-physical systems whose behavior must be continuously monitored during operation to detect deviations from normal operation before they propagate into failures. Such evaluation is challenging because the systems themselves evolve: over-the-air updates, configuration changes, and shifting workloads alter the definition of normal behavior, causing static diagnostic methods to degrade silently over time. Existing approaches typically address either automated m...

---

### 49. On the Role of Conversational Timing in Synthetic Training Data for ASR

**Authors:** Máté Gedeon, Péter Mihajlik

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08371v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08371v1)

**Summary:** Synthetic multi-speaker conversations are widely used to train conversational automatic speech recognition (ASR) systems, but it remains unclear which timing properties make simulated data most useful. This paper studies conversational timing as a controllable training variable rather than merely as a corpus statistic to be reproduced. We parameterize pause and overlap timing distributions with an exponential-tilting family estimated from multiple conversational corpora, and then explore the res...

---

### 50. FedOPAL: One-Shot Federated Learning via Analytic Visual Prompt Tuning

**Authors:** Lingyu Qiu, Daniela Annunziata, Stefano Izzo, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08368v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08368v1)
...
🔗 [Paper](http://arxiv.org/abs/2607.08768v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08768v1)
...
**Authors:** Ethan Leung, Elias Lumer, Corey Feld, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08700v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08700v1)
...
🔗 [Paper](http://arxiv.org/abs/2607.08642v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08642v1)
...
### 8. The complexities of patient-centred conversational artificial intelligence
...
### 9. It Takes a MAESTRO To Prune Bad Experts

**Authors:** Palaash Goel, Ayush Maheshwari, Tanmoy Chakraborty

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08601v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08601v1)
...
### 14. Ensemble Diversity Optimization for Subjective Supervision

**Authors:** Xia Cui, Ziyi Huang, N. R. Abeynayake

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08493v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08493v1)
...
### 15. Two Axes of LLM Abstention: Answer Correctness and Question Answerability
...
### 18. Prompt Compression via Activation Aggregation

**Authors:** Thibaud Ardoin, Semira Einsele, Evis Bregu, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08399v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08399v1)
...
### 19. Token-Flow Firewall: Semantic Runtime Auditing for Persistent AI Agents

**Authors:** Puji Wang, Yingchen Zhang, Ruqing Zhang, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08395v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08395v1)
...
### 20. Towards Mechanistically Understanding Why Memorized Knowledge Fails to Generalize in Large Language Model Finetuning
...
### 21. Large-Language-Models-as-a-Judge in Theory-Agnostic Adaptive Metric-Alignment for Prototypical Networks in Personality Recognition
...
### 22. Echoes Across Vietnam's Highlands, Delta, and Coast: A Multilingual Corpus for Cham, Khmer, and Tay-Nung

**Authors:** Anh Trac Duc Dinh, Khang Nhat Hoang Vo, Vinh Cong Doan, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08362v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08362v1)
...
### 23. Grounded Event Extraction from SEC 8-K Filings with a Fine-Grained Taxonomy

**Authors:** Rian Dolphin, Joe Dursun, Jarrett Blankenship, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08346v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08346v1)

**Summary:** Form 8-K filings are the primary channel through which U.S. public companies disclose material events, but the SEC item codes attached to them are coarse: a single item spans routine administrative changes and chief executive departures, and many of the most market-moving disclosures fall into a catch-all item. Large language models make fine-grained labelling feasible at corpus scale, but only if the labels can be traced to the source text and shown to be reliable. We present a two-stage system...

---

### 24. TypeProbe: Recovering Type Representations from Hidden States of Pre-trained Code Models

**Authors:** Giuliano Gorgone, Fausto Carcassi

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08339v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08339v1)
...
### 25. XALPHA: A Memory-Driven AI Quant Researcher for Hypothesis-to-Code Alpha Discovery

**Authors:** Fengyuan Liu, Yuchen Fu, Yuqi Wang, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08332v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08332v1)
...
🔗 [Paper](http://arxiv.org/abs/2607.08252v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08252v1)
...
### 29. Diarization-Guided Qwen-ASR Adaptation for Multilingual Two-Speaker Conversational Speech

**Authors:** Hao Wu, RongQi Han, Zhen Wang, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08208v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08208v1)
...
### 34. ICDAR 2026 HIPE-OCRepair Competition on LLM-Assisted OCR Post-Correction for Historical Documents

**Authors:** Maud Ehrmann, Emanuela Boros, Juri Opitz, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08143v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08143v1)
...
### 35. COALA: Robust Contextualized Speech-augmented Language Modeling for ASR via Contrastive Regularizer and Biasing Score Estimation

**Authors:** Jhih-Rong Guo, Bi-Cheng Yan, Tien-Hong Lo, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08117v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08117v1)
...
### 36. CausalDS: Benchmarking Causal Reasoning in Data-Science Agents

**Authors:** Andrej Leban, Yuekai Sun

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08093v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08093v1)

**Summary:** Large language models (LLMs) increasingly act as integrated data-science agents, combining abstract reasoning with advanced tool use. Yet the relevant benchmark landscape largely divides into symbolic causal reasoning benchmarks without realistic data analysis or data analysis benchmarks without a principled causal data-generating structure. Furthermore, existing causal evaluation datasets are often restricted to curated examples from existing sources, with diversity coming from limited templati...

---

### 37. MASTE: A Multi-Agent Pipeline for Zero-Shot Aspect Sentiment Triplet Extraction

**Authors:** Ao Hong, Lehang Wang, Zhirun Yue, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08080v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08080v1)

**Summary:** Aspect Sentiment Triplet Extraction (ASTE) requires jointly identifying (aspect, opinion, sentiment) triples from a given review sentence. While large language models (LLMs) achieve strong zero-shot performance on many NLP benchmarks, their effectiveness on ASTE remains limited, as single-pass generation forces the model to determine span boundaries, opinion grouping, and sentiment polarity in a single decoding step. Common remedies, such as few-shot in-context learning and chain-of-thought prom...

---

### 38. COBART: Controlled, Optimized, Bidirectional and Auto-Regressive Transformer for Ad Headline Generation

**Authors:** Yashal Shakti Kanungo, Gyanendra Das, Pooja A, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08071v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08071v1)

**Summary:** Online ads are essential to all businesses and ad headlines are one of their core creative component. Existing methods can generate headlines automatically and also optimize their click-through-rate (CTR) and quality. However, evolving ad formats and changing creative requirements make it difficult to generate optimized & customized headlines. We propose a novel method that uses prefix control tokens along with BART fine-tuning. It yields the highest CTR and also allows users to control the leng...

---

### 39. Holographic Neural PCFG for Unsupervised Parsing

**Authors:** Ryosuke Yamaki, Daichi Mochihashi, Nobutaka Shimada, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08063v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08063v1)

**Summary:** Unsupervised constituency parsing aims to accurately induce latent tree structures from raw text alone. Recent neural parameterizations of PCFGs achieve strong performance in both supervised and unsupervised parsing, yet rely on high-capacity black-box networks for rule scoring -- as exemplified by the Neural PCFG family -- leaving rule probabilities without an interpretable mathematical form. In this paper, we propose Holographic Neural PCFG (Hol-PCFG), which recasts PCFG rule scoring as algebr...

---

### 40. Towards Efficient Large Language Model Serving: A Survey on System-Aware KV Cache Optimization

**Authors:** Jiantong Jiang, Peiyu Yang, Rui Zhang, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08057v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08057v1)

**Summary:** Despite the rapid advancements of large language models (LLMs), LLM serving systems remain memory-intensive and costly. The key-value (KV) cache, which stores KV tensors during autoregressive decoding, is crucial for enabling low-latency, high-throughput LLM inference serving. In this survey, we focus on system-aware KV infrastructure for serving LLMs (abbreviated as sKis). We revisit recent work from a system behavior perspective, organizing existing efforts into three dimensions: execution and...

---

### 41. What LLM Forecasters Know but Don't Say: Probing Internal Representations for Calibration and Faithfulness

**Authors:** Raphaël Sarfati, Pratyush Ranjan Tiwari, Siddharth Boppana, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08046v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08046v1)
...
### 42. PLURAL: A Global Dataset for Value Alignment

**Authors:** Dhruv Agarwal, Anya Shukla, Tanya Goyal, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08034v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08034v1)
...
### 43. From Prompts to Contracts: Harness Engineering for Auditable Enterprise LLM Agents

**Authors:** Joongho Ahn, Moonsoo Kim

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08028v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08028v1)
...
### 44. Structured Pruning of Large Language Models via Power Transformation and Sign-Preserving Score Aggregation with Adaptive Feature Retention

**Authors:** Ryota Kobayashi, Tsubasa Hirakawa, Takayoshi Yamashita, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08027v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08027v1)
...
### 45. Can We Trust LLM's Logic? Quantifying Uncertainty, Coherence, and Robustness via a Graph-Based Framework

**Authors:** Riccardo Revalor, Jalees Rehman, Debjit Pal

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08017v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08017v1)
...
### 46. Tool-Making and Self-Evolving LLM Agents in Low-Latency Systems

**Authors:** Kalle Kujanpää, Ning Liu, Shahnawaz Alam, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08010v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08010v1)
...
### 47. From Execution to Education: A Bloom-Aligned Framework for Measuring Educational Control in LLMs

**Authors:** Yi Zhang, Julia Rayz

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08009v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08009v1)
...
### 50. When Implausible Tokens Get Reinforced: Tail-Aware Credit Calibration for LLM Reinforcement Learning

**Authors:** Xiuyi Lou, Zicheng Xu, Yu-Neng Chuang, et al.

**Published:** 2026-07-08

🔗 [Paper](http://arxiv.org/abs/2607.07976v1) | 📄 [PDF](https://arxiv.org/pdf/2607.07976v1)

**Summary:** Reinforcement learning (RL) has achieved remarkable success in enhancing the reasoning capabilities of large language models (LLMs). However, widely used critic-free RL methods rely on uniform credit assignment, broadcasting the same advantage to all tokens regardless of their differences. We identify a critical failure mode of this design, which we refer to as Positive-Credit Contamination: low-probability tail tokens that are contextually erroneous receive identical positive credit to plausibl...
...
🔗 [Paper](http://arxiv.org/abs/2607.08772v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08772v1)
...
🔗 [Paper](http://arxiv.org/abs/2607.08771v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08771v1)
...
**Authors:** Cheng-De Fan, Chun-Wei Tuan Mu, Chen-Wei Chang, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08770v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08770v1)
...
**Authors:** Weijian Chen, Weibo Yao, Yuhang Zhang, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08769v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08769v1)
...
### 5. OPSD-V: On-Policy Self-Distillation for Post-Training Few-Step Autoregressive Video Generators

**Authors:** Hongyu Liu, Chun Wang, Feng Gao, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08766v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08766v1)
...
### 6. Enhancing In-context Panoramic Generation via Geometric-aware Pretraining

**Authors:** Haoran Feng, Ruiyang Zhang, Longyi Zhang, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08765v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08765v1)
...
**Authors:** Kaifeng Zhao, Mathis Petrovich, Haotian Zhang, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08741v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08741v1)
...
### 12. LTM: Large-scale Terrain Model for Wildfire-prone Landscapes

**Authors:** Xiao Fu, Yue Hu, Meida Chen, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08711v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08711v1)

**Summary:** Accurate 3D terrain maps are essential for emergency response when assessing wildfire hazards. However, wildfire-prone regions often span vast areas where conventional reconstruction methods underperform. Airborne LiDAR systems provide high-resolution terrain data, but they are expensive and infrequently updated. Image-based methods offer a lower-cost alternative, but struggle due to sparse visual features and limited image overlap. We propose a multi-modal reconstruction framework leveraging ou...

---

### 13. HumanForge: A Human-Centric Deepfake Video Benchmark with Multi-Agent Forgery Rationales

**Authors:** Wenbo Xu, Zhimin Chen, Xiaojie Liang, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08705v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08705v1)
...
### 14. SAM-MT: Real-Time Interactive Multi-Target Video Segmentation

**Authors:** Ruiqi Shen, Chang Liu, Henghui Ding

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08688v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08688v1)
...
### 15. Multi-Resolution Feature Stem for Diabetic Retinopathy lesion segmentation

**Authors:** Indranil Dutta, Taehee Jeong

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08679v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08679v1)
...
### 16. Do Transformations Reveal the Truth? Generative Residual Learning for Generalized AI-Generated Image Detection

**Authors:** Kutub Uddin, Nusrat Tasnim, Awais Khan, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08674v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08674v1)
...
🔗 [Paper](http://arxiv.org/abs/2607.08639v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08639v1)
...
### 19. Switch-Reasoner: Learn When to Think in Multitask Mixtures via Reinforcement Learning

**Authors:** Yiyang Fang, Pei Fu, Jinjie Li, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08572v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08572v1)
...
### 21. Whareformer: Learning to Track What is Where in Long Egocentric Videos

**Authors:** Jacob Chalk, Saptarshi Sinha, Dima Damen, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08537v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08537v1)
...
### 24. Systematic Evaluation of Learning Rate Scheduling Strategies Across Heterogeneous Architectures

**Authors:** Hafsa Mateen, Radu Timofte, Dmitry Ignatov

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08511v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08511v1)
...
### 25. CT-CLIP Representations for Multimodal Lung Cancer Survival Prediction

**Authors:** Sofie Allgöwer, Mikael Johansson, Andreas Hallqvist, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08503v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08503v1)
...
### 26. Cognitive-structured Multimodal Agent for Multimodal Understanding, Generation, and Editing
...
### 27. VEGAS: Human-Aligned Video Caption Evaluation via Gaze
...
### 28. Predicting Viticulture Potential through an Ensemble of U-Net and a Geospatial Foundation Model

**Authors:** Jorge Ignacio Perez, Hwaai Kang Kee, Lucas Rassbach

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08449v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08449v1)
...
### 31. Swapping Faces, Saving Features: A Dual-Purpose Pipeline for Pedestrian Privacy in ITS
...
### 32. HoloTetSphere: Unified TetSphere Mesh Reconstruction for Physical Simulations

**Authors:** YaQiao Dai, Renjiao Yi, Zhirui Gao, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08398v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08398v1)

**Summary:** Standard pipelines for physics-ready 3D reconstruction rely on a decoupled two-stage paradigm: extracting surface geometry followed by an error-prone tetrahedralization process. While recent Lagrangian methods like TetSphere Splatting attempt to bypass this by directly optimizing volumetric primitives, their homeomorphic constraints prevent topology-adaptive optimization. Consequently, they produce disjoint tetrahedra rather than a single connected mesh, rendering the structures unsuitable for f...

---

### 33. Attribute Retrieving for Open-Vocabulary Endoscopic Compositional Referring Segmentation

**Authors:** Shun Liu, Nan Xi, Yang Liu, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08397v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08397v1)
...
### 34. Classical versus Deep Mirror-Symmetry Scoring: A Benchmark of Thirteen Methods

**Authors:** Maximilian Woehrer

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08379v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08379v1)

**Summary:** Quantifying how mirror-symmetric an image is about a given axis (symmetry scoring) underpins applications from visual aesthetics to medical imaging, yet proposed scoring methods have never been compared on a common, statistically grounded protocol. We benchmark 13 scoring methods (nine collected from literature, four introduced here) spanning from classical features to frozen deep features, across four single-axis and five multi-axis datasets under a reflection-exact protocol with a chance-ancho...

---

### 35. WCog-VLA: A Dual-Level World-Cognitive Vision-Language-Action Model for End-to-End Autonomous Driving
...
### 36. Texture Representations in Deep Vision Models: Comparing CNNs, Vision Transformers, and Human Perception

**Authors:** Ludovica de Paolis, Marco Baroni, Alessandro Laio, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08321v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08321v1)
...
### 37. ARGUS: Accelerated, Robust, General, and Unsupervised Cell Tracking Solutions

**Authors:** Noah Jaitner, Kandice Tanner, Ingolf Sack, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08297v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08297v1)
...
### 38. Enhancing the KidSat Model: Integrating Geographical Encoding and Data Quality Assessment for Childhood Poverty Prediction

**Authors:** Hou Hin Ip, Ka Nam Lam, Joshua Man Yu Ng, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08281v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08281v1)
...
### 39. Progression as Latent Drift: Generative Forecasting of Slow-Evolving Pathologies

**Authors:** Yuxiang Feng, Juncheng Wang, Chao Xu, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08270v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08270v1)
...
### 43. SkelGen4D: Weakly-Supervised Skeleton-Based 4D Generation for Text-Driven Mesh Animation

**Authors:** Hao Feng, Zhi Zuo, Jia-Hui Pan, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08246v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08246v1)

**Summary:** We study 4D generation to synthesize temporally coherent sequences of 3D geometry for animation and content creation. In contrast to existing SDS-based optimization methods and video-driven animation approaches, we adopt a skeleton-driven animation framework aligned with standard industrial pipelines, which enables explicit control and editing. To this end, we propose SkelGen4D, a weakly supervised feed-forward framework for text-driven mesh animation that generates explicit skeleton motions wit...

---

### 44. Closing the Null Space: Guidance-Aware Quantization for Classifier-Free Diffusion

**Authors:** Abdullah Al Shafi, Sumaiya Rahim Suma

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08241v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08241v1)

**Summary:** Deploying classifier-free guidance (CFG) diffusion models under real-world compute budgets requires quantization, yet existing post-training quantization (PTQ) methods treat CFG models as single-branch networks, ignoring the paired conditional/unconditional structure that CFG inference fundamentally relies on. This structural blind spot has two consequences. At the system level, the two-pass CFG execution pattern imposes a latency overhead that parameter-count and bit-operation metrics conceal e...

---

### 45. TVTA: Trajectory-Aware Viseme-Guided Temporal Aggregation for Event-Based Lip Reading

**Authors:** Jingrong Zheng, Hongwei Ren, Xiangqian Wu

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08236v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08236v1)

**Summary:** Event-based lip reading has recently emerged as a promising direction for visual speech recognition, benefiting from the high temporal resolution and motion sensitivity of event cameras. However, existing methods typically perform spatial compression before sufficient temporal modeling, which may suppress sparse and localized motion trajectories that are crucial for distinguishing similar lip movements. Moreover, most current approaches optimize temporal representations mainly at the word-classi...

---

### 46. Playing ZendoWorld: Challenging AI Agents on Active Visual Concept Induction

**Authors:** Sophia Koehler, Antonia Wüst, Inga Ibs, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08233v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08233v1)

**Summary:** A central challenge in building intelligent systems is enabling agents to jointly perceive complex inputs, form hypotheses about hidden patterns, and design informative experiments to test them. To study this problem, we propose ZendoWorld, a controlled interactive environment in which agents must infer a logical rule about visual game observations, acquire information by proposing new scenes, and refine their hypotheses based on feedback from the game environment. We evaluate several agents spa...

---

### 47. Multimodal 3D LUT Generation via StatLUT with Statistical Features for Photorealistic Style Transfer

**Authors:** Yifan Wang, Zhixiang Hao, Yu Wang, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08227v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08227v1)
...
### 48. LUMI: Tokenizer-Agnostic LLM-Based Lossless Image Compression

**Authors:** Chris Xing Tian, Chengkai Wu, Ziyu Wang, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08221v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08221v1)
...
### 49. Benchmark Evaluation of Feredated Learning on Multi-organ Images

**Authors:** Junbin Mao, Xu Tian, Jianchun Zhu, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08219v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08219v1)

**Summary:** The privacy requirements of medical data and its substantial variations across organs and modalities hinder the clinical implementation of medical AI. Federated learning (FL) is a feasible approach to overcome these challenges. Due to the continuous emergence of FL algorithms and the highly heterogeneous nature of medical data, objectively evaluating their performance in real-world clinical settings remains difficult. Therefore, a comprehensive federated medical imaging benchmark, serving as a u...

---

### 50. Metrics or Mirage? An Audit of Evaluation Inconsistencies in Colonoscopy Polyp Segmentation Benchmarks

**Authors:** Aisha Urooj, Zain Ul Abdien, Neelu Madan

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08203v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08203v1)

**Summary:** Progress in colonoscopy polyp segmentation is routinely reported through leaderboard comparisons on a small set of public benchmarks. We argue that this apparent progress is difficult to verify: a systematic audit of \textbf{27 papers} published between 2015 and 2026 reveals three structural problems in how the community evaluates models. \textbf{First}, 25 of 27 papers \textit{omit the Hausdorff distance}. Hausdorff distance is a boundary-accuracy metric with direct clinical relevance for detec...
...
🔗 [Paper](http://arxiv.org/abs/2607.08757v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08757v1)
...
🔗 [Paper](http://arxiv.org/abs/2607.08756v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08756v1)
...
### 4. Dimensionality Reduction Meets Network Science: Sensemaking on UMAP's kNN Graph
...
### 6. Super Weights in LLMs and the Failure of Selective Training

**Authors:** Shreyas Subramanian, Adewale Akinfaderin, Akarsha Sehwag

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08733v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08733v1)
...
🔗 [Paper](http://arxiv.org/abs/2607.08724v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08724v1)
...
### 9. Deep Learning for Joint Narrowband Interference Cancellation and Soft Demodulation in OFDM Systems

**Authors:** Emmanouil Kavvousanos, Francky Catthoor, Vassilis Paliouras

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08717v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08717v1)
...
### 10. LTM: Large-scale Terrain Model for Wildfire-prone Landscapes
...
**Authors:** Harrison Rush, Vincent Davis, Simone Antonelli, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08703v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08703v1)
...
🔗 [Paper](http://arxiv.org/abs/2607.08665v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08665v1)

**Summary:** Routing among large language models (LLMs) trades response quality against serving cost, motivated by the reported gap between deployed routers and a per-instance oracle. Recent analysis shows that test-time resampling can recover per-instance selection headroom that no single-commit router captures; however, that guarantee holds only under an idealized oracle equipped with correctness labels and an unconstrained budget, neither of which a deployed system has. To the best of our knowledge, no pr...

---

### 14. EdgeRefine: Privacy-Utility Balance for Graphs via Jaccard Sampling under Edge Differential Privacy

**Authors:** Wenxiu Ding, Muzhi Liu, Zheng Yan, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08659v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08659v1)
...
**Authors:** Yuantian Shao, Peisong Wang, Zhilei Liu, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08643v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08643v1)
...
### 18. Steering Neural Network Training through Interpretable Constraints Based on Partial Dependence

**Authors:** Yann Claes, Pierre Geurts, Vân Anh Huynh-Thu

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08641v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08641v1)

**Summary:** Over the last few years, there has been an increased interest in making machine learning models more interpretable. Although a great deal of effort goes into developing techniques for interpreting the interactions learned by a given model, fewer studies focus on assessing the quality of such explanations. Even fewer focus on how to adjust the model to produce explanations faithful to prior knowledge, a process known as explanation-guided learning. Furthermore, most approaches in this area focus ...

---

### 19. When Structured Sparse Autoencoders Learn Consistent Concepts Across Modalities
...
### 20. Federated Deep Learning for Privacy-Preserving Cardiovascular Disease Risk Prediction

**Authors:** Hyunho Mo, Djura Smits, Mahlet A. Birhanu, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08595v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08595v1)

**Summary:** Cardiovascular disease risk prediction models often rely on data from a single institution or centrally pooled datasets. Extending these models across institutions could be limited by privacy regulations and constraints on sharing patient-level data. Federated learning enables collaborative model development without transferring sensitive patient data, but its application in healthcare remains challenging because datasets often differ in size, population characteristics, and outcome definitions....

---

### 21. Robust Bayesian Decision Making under Adversarial Uncertainty

**Authors:** Haripriya Harikumar, Sammie Katt, Yasir Zubayr Barlas, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08590v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08590v1)

**Summary:** Scientific experiments are often designed to maximize information gain, yet in many applications the primary objective is to support reliable downstream decision-making. Existing decision-aware experimental design and active learning methods typically assume well-specified outcome models and implicitly rely on the stability of the optimal decision under real-world perturbations. In practice, however, experimental outcomes are frequently influenced by hidden or weakly modeled effects, which can s...

---

### 22. Spectral Stability of Pseudoinverse-Based Extreme Learning Machine

**Authors:** Bich Van Nguyen, Ngoc Anh Khong

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08581v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08581v1)

**Summary:** Extreme Learning Machine (ELM) computes output weights analytically using the Moore-Penrose pseudoinverse. Although this leads to fast training, its numerical stability depends strongly on the conditioning of the hidden layer matrix. This paper studies pseudoinverse-based ELM from a spectral perspective. We show that the smallest singular value governs perturbation amplification in the output weights, while the condition number provides a quantitative measure of hidden-layer instability. We comp...

---

### 23. ImputeViz: A Visual Analytics Dashboard for Diagnosing Missing Data and Comparing Imputation Methods

**Authors:** Aitik Dandapat, Lalith Punepalle Raveendrareddy, Mithilesh Kumar Singh, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08579v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08579v1)

**Summary:** Missing data is a persistent obstacle in scientific, social science, and public health research, often biasing analyses and placing accountability on analysts for how they handle missing values. We introduce ImputeViz, an integrated visual analytics dashboard that supports diagnosing missingness, configuring imputation models, and evaluating results. The system brings together widely used methods, including MICE, Random Forest, XGBoost, and kNN, within an interactive environment that makes missi...
...
**Authors:** Xin Wang, Yunshi Wen, Yanan He, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08555v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08555v1)

**Summary:** The operational integrity of complex industrial systems relies on precise anomaly detection and diagnosis. The vast majority of existing methods narrowly focus on capturing temporal similarities of representations, often overlooking the disruption of internal causal relationships, which characterizes system failures and latent anomalies. In this paper, we propose a novel framework (CAAD) that reframes anomaly detection as the continuous verification of Granger causality consistency through exoge...

---

### 26. Structural Bottlenecks on Frequency Representation in End-to-End Audio Models

**Authors:** Nicole Cosme-Clifford

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08545v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08545v1)

**Summary:** End-to-end neural audio models achieve high-fidelity compression and generation. We might read that performance as evidence they directly represent interpretable features such as pitch and timbre, but a model can produce plausible outputs without doing so. A model may encode these features in any reachable basis, but regardless of which, the features are well described as compositions of time-frequency-localized primitives. Whether state-of-the-art encoders preserve access to these primitives, a...

---

### 27. High-Dimensional Procrustes Matching via Tree Counts

**Authors:** Xiaochun Niu, Tselil Schramm, Jiaming Xu

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08538v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08538v1)

**Summary:** Suppose we observe two sets of $n$ Gaussian vectors in $\mathbb{R}^d$, with the promise that, after applying a permutation of $[n]$ and a rotation of $\mathbb{R}^d$, the two sets are $ρ$-correlated. The Procrustes matching problem asks us to recover the unknown permutation of $[n]$ that aligns the two sets. The problem is well-studied in the low-dimensional regime $d=O(\log n)$, but the high-dimensional regime $d\gg \log n$ has remained largely uncharted: prior matching guarantees require nearly...
...
### 29. Stop Guessing When to Stop Testing: Efficient Model Evaluation with Just Enough Data

**Authors:** Ofir Arviv, Kristjan Greenewald, Yotam Perlitz, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08522v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08522v1)

**Summary:** The inherent rigidity of fixed-size benchmarks makes them an inefficient tool for model evaluation. Diverse evaluation objectives, including model ranking, model selection and testing throughout development, demand varying levels of statistical power. The mismatch between fixed sample sizes and these diverse needs results in either excessive computational cost or compromised reliability - a critical concern for model evaluation. To overcome these limitations, we call for adoption of sequential t...

---

### 30. Systematic Evaluation of Learning Rate Scheduling Strategies Across Heterogeneous Architectures
...
### 31. Cognitive-structured Multimodal Agent for Multimodal Understanding, Generation, and Editing
...
### 32. Ensemble Diversity Optimization for Subjective Supervision
...
**Authors:** Jiewen Deng, Hangchen Liu, Junchen Li, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08475v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08475v1)

**Summary:** Multi-modality transportation refers to urban systems composed of multiple transportation modes, such as traffic flow and public transit, whose dynamics are coupled by shared temporal patterns. Accurate multi-modality transportation forecasting remains challenging because (1) different modalities exhibit distinct spectral characteristics and (2) interact unevenly across frequencies, whereas most existing methods operate primarily in the time domain or rely on coarse feature fusion. To address th...

---

### 34. MatBind: A Shared Embedding Space for Multimodal Materials Characterization

**Authors:** Le Yang, Anoop K. Chandran, Jona Östreicher, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08470v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08470v1)

**Summary:** Fully characterizing a crystalline material requires integrating heterogeneous data sources -- atomic structures, diffraction patterns, electronic density of states, and natural language -- each of which captures a different facet of the same physical object. In practice, however, these modalities are stored and analyzed in isolation, making it difficult to relate or query materials across representational boundaries. We present MatBind, a contrastive learning framework that aligns four material...

---

### 35. Predicting Viticulture Potential through an Ensemble of U-Net and a Geospatial Foundation Model
...
🔗 [Paper](http://arxiv.org/abs/2607.08444v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08444v1)
...
### 38. FPGN: Redefining Ultra-Fast Programmable Gate-based Neural Acceleration with Differentiable LUTs

**Authors:** Jiawei Liang, Haotong Qin, Linfeng Du, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08427v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08427v1)

**Summary:** Achieving nanosecond-scale inference latency for deep neural networks (DNNs) has become a primary architectural concern for latency-critical applications. While Field-Programmable Gate Arrays (FPGAs) offer a promising substrate for low-latency inference, conventional FPGA accelerators remain arithmetic-centric, using LUTs primarily as building blocks for numerical operators and peripheral logic. In contrast, recent LUT-native neural networks treat LUTs as learnable neurons, revealing promising t...

---

### 39. Beyond Backpropagation: Monte Carlo Method Can Train Deep Neural Networks

**Authors:** Hong Zhao

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08406v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08406v1)

**Summary:** Backpropagation (BP) dominates deep learning training, but its reliance on gradients brings inherent troubles -- vanishing and exploding gradients. The pursuit of gradient-free methods has long been a goal in the field of artificial intelligence. This paper shows that indeed the simplest Monte Carlo algorithm implemented on a single GPU -- randomly mutate a parameter, keep it if the loss decreases, otherwise retry -- can practically train deep networks. This gradient-free method does not even ne...

---

### 40. DrugGen 2: A disease-aware language model for enhancing drug discovery
...
### 41. TRACE: A Two-Channel Robust Attribution Watermark via Complementary Embeddings for LLM-Agent Trajectories
...
### 43. Joint Discrete-Continuous Flow Matching for Open-Vocabulary Inverse Design of Multilayer Optical Coatings

**Authors:** Zhiyi Li, Yuheng Jin, Yidan Huang, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08392v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08392v1)

**Summary:** Amortized neural inverse design typically remains closed-world: component choices are fixed vocabulary tokens, coordinate grids are frozen at training time, and continuous variables are discretized into sequence tokens. Multilayer optical coatings are an industrially important instance, coupling material sequence, layer thickness and wavelength-dependent response. We present IrisFlow, a query-based, open-vocabulary flow-matching framework instantiated in coatings: the target reflectance/transmit...

---

### 44. On Exploring Input Resolution Scaling For Anytime LiDAR Object Detection

**Authors:** Ahmet Soyyigit, Shuochao Yao, Heechul Yun

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08391v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08391v1)

**Summary:** Making tradeoffs between execution latency and result utility (i.e., anytime computing) for adapting to dynamic operational requirements has been shown to enhance the performance of cyber-physical systems. In this work, we focus on enabling anytime computing for deep neural networks (DNNs) that process LiDAR point clouds for 3D object detection. We propose a novel method that enables multi-resolution inference for models that process point clouds as pillars or voxels, allowing the input to be dy...

---

### 45. Revisiting One-Zero and Two-Zero Neutrino Mass Textures in Light of Recent Oscillation and Cosmological Data

**Authors:** Haruto Kitagawa, Coh Miyao, Satsuki Nishimura, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08384v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08384v1)

**Summary:** We revisit one-zero and two-zero textures of the neutrino mass matrix under current experimental and cosmological constraints. We identify the phenomenologically viable texture structures using the latest results on neutrino oscillation parameters, the cosmological bound on the sum of neutrino masses, the kinematic bound on the effective electron-neutrino mass, and limits from neutrinoless double-beta decay. For two-zero textures, several structures are still allowed if only the CMB bound on the...

---

### 46. Dynamics of Gradient Descent with Large Step Size Near a Manifold of Flat Minima

**Authors:** Lachlan Ewen MacDonald, René Vidal

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08380v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08380v1)

**Summary:** An important quantity in the theory of gradient descent (GD) is the \emph{sharpness}, defined as the largest eigenvalue of the objective Hessian. Classical analyses typically require the step size to be uniformly smaller than twice the reciprocal of the sharpness, but this condition is frequently violated in the training of deep neural networks. Recent work bridges this gap in the setting of overparametrised least-squares with a \emph{single scalar output}, providing a normal form for large-step...

---

### 47. Eigenvalue Calibration for Semantic Embeddings of Large Language Models

**Authors:** Sebastian G. Gruber, Nassim Walha, Francis Bach, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08377v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08377v1)
...
### 49. Tubular Neighbourhoods of Pfaffian Sets and Applications to Neural Networks

**Authors:** Paul Lezeau, Martin Lotz

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08370v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08370v1)
...
### 50. Certified Interventional Fidelity: Anytime-Valid, Adaptive Evaluation of Causal Claims in Mechanistic Interpretability

**Authors:** Amir Asiaee

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08349v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08349v1)
...
### 1. Sampling on Random Subspaces under Limited Data in the Context of Exploratory Landscape Analysis
...
### 3. Single-Entity Spiking Neuron Models: Survey
...
### 4. Dynamic neural manifolds for flexible closed-loop control on neuromorphic hardware
...
### 5. Intrinsic-Noise Consolidation: A Doob-Barrier-Conditioned Diffusion Turns Analog Device Noise into a Continual-Learning Resource
...
### 6. An Introduction and Tutorial of the Beagle Framework
...
### 7. A Hardware-Aware Open-Source Framework for Design Space Exploration of Mixed-Signal Spiking Neural Networks
...
### 8. Scalable Perturbation Learning for Online Self-Supervised Echo State Networks
...
### 9. An event-driven framework for fly-inspired visual motion detection
...
### 10. LLM for the development of FCM
...
### 11. A Large-Scale Sparse Multiobjective Optimization Algorithm Based on Optimal Performance Scores
...
### 13. Neuromorphic Silicon Neuron Controller for Adaptive Deep Brain Stimulation in Parkinson's Disease
...
### 14. Rank-Order N-of-M Codes for Sparse Distributed Memory: Disentangling Representation and Learning Effects in Noise Robustness Against Contemporary Neuromorphic Architectures
...
### 15. Microcosmos: Reimagining Artificial Life for the GPU Era
...
### 16. A Spiking Sequence Generator for Polar Trajectories on Neuromorphic Hardware
...
### 17. Stable Self-Modulating Quantum Fast-Weight Programmers with Bounded Memory Gates
...
### 19. Dendritic In-Context Learning in a Single-Layer Spiking Neural Network
...
### 20. Predicting Early Stages Of Alzheimer's Disease And Identifying Key Biomarkers Using Deep Artificial Neural Network And Ensemble Of Machine Learning Methodologies
...
### 21. Electronic Bursting Neuron: design, equations and hardware implementation
...
### 22. Evolutionary Wave Function Collapse
...
### 23. Mechanism and Stability Analysis of Metabolic Closed-Loop Metaheuristics
...
### 24. MMAO-Cls: Metabolic Multi-Agent Optimization for Joint Feature Selection and Classifier Tuning
...
### 25. BFF: Simple explanations for complex phenomena
...
### 26. Towards transferable lightweight neuromorphic computing through a model-free temporal-switch framework
...
### 27. MMAO-Dyn: A Metabolic Multi-Agent Optimizer for Dynamic Optimization
...
### 28. From Consistency to Collaborative Discovery: MFEA-CoD for Multitask Novelty Search
...
### 29. Self-Organized Learning in Oscillatory Neural Networks with Memristive Signed Couplings
...
### 30. EVOTS: Evolutionary Transformer Search for Time Series Forecasting
...
### 31. Evaluation of Population Initialization Methods for Genetic Programming-based Symbolic Regression
...
### 32. Distributed Hierarchical Temporal Memory with Shared Associative Memory for Cross-Entity Preemptive Warning
...
### 34. A Large-Scale Empirical Evaluation of MMAO Under Fair-Budget Continuous and Discrete Benchmarks
...
### 35. Robustness of neural networks to random noise perturbations of their inputs
...
### 36. Partition-Guided Distance Saliency: Bridging Decision and Objective Spaces in Many-Objective Optimization
...
### 37. Why can genetic algorithms work in high-dimensional search spaces?
...
### 38. Computing the Integral R2 Indicator by Perspective Mapping and Box Decomposition
...
### 39. Minimal MMAO: A Resource-Closed-Loop Framework for Adaptive Metaheuristic Search
...
### 40. From Detecting Agency to Doing Work: Self-Caused Credit Builds a Durable Behavioral Self in a Minimal Spiking Agent
...
### 41. Semantics-Aware Bilevel Co-Evolution: Towards Automated Multicomponent Algorithm Design
...
### 42. Evolutionary Hyperparameter Optimization to Find Lightweight CNN Models for Autonomous Steering
...
### 43. Geometric Stability of Neural Population Codes: Regional Variation, Behavioral Relevance, and Circuit Dependence
...
### 44. Supervised Hebbian learning in Deep Counterstream Associative Networks
...
### 45. When LLMs Develop Languages: Symbolic Communication for Efficient Multi-Agent Reasoning
...
### 46. Travel-Oriented Reasoning Large Language Model via Domain-Specific Knowledge Graphs
...
### 47. Unified Complex-valued Neural Network: A Magnitude-Phase Computational Model for Event-Driven Neuromorphic Learning
...
### 48. Road to scalability for efficient graph search on massively parallel neuromorphic hardware
...
### 49. Closed-Form Steepest Descent Direction toward Flat Minima: Reducing Upper Bounds on the Loss Hessian Eigenspectrum in Neural Networks
...
### 50. Analysis of Parameter Settings for the Bat Algorithm Using Variance Evolution
...
### 2. A Non-Hermitian Potential Well Formalism for Conscious--Preconscious--Subliminal Processing
...
### 4. Quantifying Entrainment Evidence: A Comparison of Frequentist and Bayesian Approaches for Information Processing Pathway Maps
...
### 6. Reward Valuation in Vision Language Models: Causal Mechanisms Underlying Anhedonia
...
### 7. Using hierarchical statistical learning models to model individual statistical learning
...
### 8. On the Increased and Decreased Connectivity of the Demented Human Brain
...
### 9. Governable Individuals: An Identity Layer for Embodied Agents That Keep Learning
...
### 10. Beyond DSA: Conjugacy-based Comparison of Dynamical Systems
...
### 11. Learning Biophysical Models of Large-Scale Multineuronal Data to Enable Precise Neurostimulation
...
### 12. Microsecond-precision sound localization emerges from slow equilibrium dynamics
...
### 13. Diffusion learning reveals viable parameter manifolds and compensation geometry in biological dynamical systems
...
### 14. Shunting Inhibition and Dendritic Branching Shape Local Credit Assignment
...
### 15. Modeling the Impact of Visual Brand Language on Attention, Object Recognition, and Memory Retrieval
...
### 16. A global predicted-fMRI drive signal from TRIBE does not predict YouTube replay heatmaps
...
### 17. DRIADA: A Python Toolkit for Cross-Scale Analysis of Single-Neuron Selectivity and Population Dynamics
...
### 18. NeuroCogMap Reveals Cognitive Organization of Large Language Models
...
### 19. Stationary covariance spectra of discrete-time non-normal random recurrent dynamics
...
### 20. Mean-field theory of rich oscillatory dynamics in low-rank recurrent networks with activity-dependent adaptation
...
### 21. Cohort-amortized personalization: navigating the privacy-utility frontier for virtual brain twins
...
### 22. Clear Mind: Meditation and the Brain's Signal-to-Noise Ratio
...
### 23. Geometric Stability of Neural Population Codes: Regional Variation, Behavioral Relevance, and Circuit Dependence
...
### 24. Connectivity Estimation using Stochastic Graph Heat Modelling
...
### 25. Interpretable machine learning predicts Parkinson's disease severity using motion-corrected QSM MRI and multiband multiecho fMRI features
...
### 26. Modelling Emotional Memory in Children with Tensor Networks
...
### 27. Heterogeneous synaptic motifs bridge microscale structure and macroscale nonlinear dynamics
...
### 28. CANNs: A Toolkit for Research on Continuous Attractor Neural Networks
...
### 29. Modelling chronic stress as an excitatory-inhibitory perturbation in recurrent working-memory networks
...
### 31. Closing the Loop to Discover Psychological Theories with an Automated Cognitive Scientist
...
### 32. Beyond Single-Source Cognitive Taskonomy:Multi-Source Task Relations through fMRI Transfer Learning
...
### 33. Topology-Dependent Emergence of Polychronous Neuronal Groups: A Recurrence-Plot Characterization
...
### 34. Weight geometry governs functional memory in complex systems
...
### 35. Meta-learning as a principle for human-like visual representations
...
### 36. A pilot study examining transcranial photobiomodulation therapy intervention in college students with insomnia
...
### 37. EEG Interpretation Across Chant Listening: A Single-Subject Pilot Investigation Using Spectral and Functional Connectivity Analysis
...
### 38. Average Rankings Mask Per-Subject Optimality: A Friedman-Nemenyi Benchmark of EEG Motor-Imagery BCI Decoders
...
### 39. Graph-based analysis of inflammatory profiles in New Onset Refractory Status Epilepticus (NORSE)
...
### 40. The Morality Game: An online multiplayer platform to standardize, expedite, and expand research on cooperation
...
### 41. Identifying structural design principles shaping the computational abilities of recurrent neural networks
...
### 42. The adaptive nature of confirmation bias
...
### 43. Estimating common synaptic inputs to spinal motor neurons from motor unit spike trains using openhdemg
...
### 44. SPIDER -- Stitched Power-spectra for Inferring Directed information flow from incomplete and asynchronous Experimental Recordings
...
### 45. DevoTG: Temporal Graph Neural Networks for Modeling C. elegans Developmental Connectomics
...
### 46. Dynamic Computerized Tumbling-E Testing for Temporal Reliability of Human Sequential Perceptual Decisions
...
### 47. Mostly-monocular responses and other visual functions in a multiscale network model of Macaque V1
...
### 48. Delay coordinates synchronization and induces abrupt transition in excitable networks
...
### 49. Adaptive conduction delays and phase locking in spiking Haken Lighthouse networks
...
### 3. Statistical Efficiency and Inference of Quantile Distributional Reinforcement Learning
...
### 4. Beyond Backpropagation: Monte Carlo Method Can Train Deep Neural Networks
...
### 5. Prediction-Powered Active Testing

**Authors:** Kianoosh Ashouritaklimi, Valentin Kilian, Daolang Huang, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08347v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08347v1)

**Summary:** Active testing provides a label--efficient approach to risk estimation by adaptively selecting which test points should be labelled. However, existing estimators fail to exploit the informative predictions of powerful black--box models, even though such predictions are increasingly available in settings where labels remain expensive. To address this, we propose \textbf{Prediction--Powered Active Testing (PPAT)}, a novel label--efficient risk estimation framework that combines the unbiased LURE e...
...
🔗 [Paper](http://arxiv.org/abs/2607.08337v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08337v1)

**Summary:** Diffusion unlearning is essential for mitigating the generation of harmful or copyrighted content in text-to-image models. Current diffusion unlearning techniques determine the model update direction by either using alternatives of the target concept as an anchor or using empty prompts. The anchor-based method relies on manually and semantically-chosen anchors that risk biased unlearning, while the anchor-free method inherently suffers from unrobust unlearning due to unconstrained latent updates...

---

### 7. Bayesian Experimental Design via Score Matching

**Authors:** Angus Phillips, Gavin Kerrigan, Tom Rainforth

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08335v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08335v1)

**Summary:** Policy-based approaches to Bayesian experimental design (BED) allow the learning of deep policy networks that adaptively make intelligent design decisions based on previously collected data. However, the training of such policies is often held back by a fundamental challenge: the double intractability of the expected information gain (EIG). This necessitates expensive or complex approximations that restrict the effort one can invest in optimising the policy itself. To address this, we show that ...

---

### 8. A scalable version of MADD for big-data classification

**Authors:** Annesha Ghosh, Adrija Saha, Soham Sarkar

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08334v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08334v1)

**Summary:** Distance-based classifiers are very popular, and the Euclidean distance is one of the most commonly used metrics in distance-based classifiers. However, classifiers based on the Euclidean distance often suffer in high-dimensional setups due to issues such as distance concentration, violation of neighborhood structures, and the presence of hubs. In high-dimension, low-sample-size (HDLSS) situations, a data-driven semi-metric called the Mean Absolute Difference of Distances (MADD) is known to circ...

---

### 9. An interpretable Good--Turing restart criterion for k-means++

**Authors:** Renato Cordeiro de Amorim

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08243v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08243v1)

**Summary:** The k-means++ algorithm is commonly restarted multiple times to avoid poor local optima, yet the number of restarts is almost always chosen arbitrarily and applied uniformly regardless of data set difficulty. This undermines any comparison relying on such a choice and wastes computation on easy data sets while potentially under-serving hard ones. We introduce GTRC, a restart criterion combining a Good-Turing estimate, a proven unconditional bound, and a confidence-based bound on the probability ...

---

### 10. Structure Learning on Clustered Data

**Authors:** Ryan Thompson, Matt P. Wand, Veerabhadran Baladandayuthapani

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08238v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08238v1)

**Summary:** Recent algorithmic advances have made directed acyclic graph (DAG) structure learning scalable for causal discovery. Yet, the currently available techniques assume a completely homogeneous population, precluding their application to clustered data where cluster-specific variations (e.g., patient-specific effects) are common. We address this issue by introducing a new approach that estimates a global structure while accounting for local cluster-level effects. The key idea is to extend the fixed- ...

---

### 11. Selecting Interpretable Circular Coordinates from Data

**Authors:** Vincent P. Grande, Marina Meila

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08230v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08230v1)

**Summary:** Circular coordinates obtained from persistent cohomology reveal loop structure in data, but they usually remain abstract: A detected circle does not tell us which measured angle, phase, torsion, or decoder explains it. We propose a method for selecting interpretable circle-valued coordinates from a user-supplied dictionary of scientifically meaningful candidates explaining the detected cohomology. In the continuous setting, each candidate is represented by the cohomology class of its pulled-back...

---

### 12. Joint estimation of high-dimensional spiked covariance matrices via a partially shared subspace

**Authors:** Changwon Yoon, Minwoo Kim, Sungkyu Jung, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08123v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08123v1)

**Summary:** Statistical analysis of high-dimensional data is often hampered by limited sample sizes, yet auxiliary datasets from related sources are often readily available. When two such datasets share part of their covariance structure, but not all of it, exploiting the shared part can substantially improve estimation. We propose a spiked covariance model that explicitly captures this partial sharing: two datasets share a subspace of unknown rank and arbitrary position in the spectrum, while each retains ...

---

### 13. Reinforcing the Generation Order of Multimodal Masked Diffusion Models

**Authors:** Yidong Ouyang, Zhe Wang, Sourav Bhabesh, et al.

**Published:** 2026-07-09

🔗 [Paper](http://arxiv.org/abs/2607.08056v1) | 📄 [PDF](https://arxiv.org/pdf/2607.08056v1)
...
### 14. Expressivity and Statistical Trade-offs in Diffusion Policy Learning

**Authors:** Viet Vu, Renyuan Xu, Jiacheng Zhang, et al.

**Published:** 2026-07-08

🔗 [Paper](http://arxiv.org/abs/2607.07967v1) | 📄 [PDF](https://arxiv.org/pdf/2607.07967v1)

**Summary:** Diffusion-based policies have recently emerged as powerful policy parameterizations for reinforcement learning, representing state-conditioned action distributions as terminal laws of diffusion processes with parameterized drifts. This terminal-law representation has shown substantial expressive flexibility in practice, enabling diffusion policies to model complex, multimodal, and highly non-Gaussian action distributions; however, it remains unclear what mathematically drives this expressivity a...

---

### 15. Mixtures of spatial factor analyzers for tensor-variate data

**Authors:** Hanzhang Lu, Keiran Malott, Kirsty Milligan, et al.

**Published:** 2026-07-08

🔗 [Paper](http://arxiv.org/abs/2607.07887v1) | 📄 [PDF](https://arxiv.org/pdf/2607.07887v1)

**Summary:** A mixture of spatial factor analyzers (MSFA) is introduced to address the challenges of clustering high-dimensional spatial data. By leveraging the underlying coordinate system, the proposed framework incorporates a flexible, spline-based spatial decay covariance structure that prevents parameter inflation as dimensionality increases. To model non-spatial dependence, matrix variate factor analyzers are employed for further dimensionality reduction. Parameter estimation is conducted via a variant...

---

### 16. A law of robustness for two-layer neural networks with arbitrary weights

**Authors:** Yitzchak Shmalo

**Published:** 2026-07-08

🔗 [Paper](http://arxiv.org/abs/2607.07778v1) | 📄 [PDF](https://arxiv.org/pdf/2607.07778v1)

**Summary:** Bubeck, Li and Nagaraj conjectured that, for generic data, any two-layer neural network with $m$ neurons that fits $n$ noisy labels must have Lipschitz constant at least of order $\sqrt{n/m}$, with no restriction on the size of the weights. Bubeck and Sellke proved a universal version of this law for Lipschitz-parameterized classes, but under a polynomial bound on the parameters; at depth three that boundedness hypothesis is genuinely necessary. The two-layer unbounded-weight case requires a dif...

---

### 17. Distributionally Faithful Imputation via Positive Semi-Definite Kernel Density Estimation

**Authors:** Andrea Basteri, Carlo Ciliberto, Alessandro Rudi

**Published:** 2026-07-08

🔗 [Paper](http://arxiv.org/abs/2607.07767v1) | 📄 [PDF](https://arxiv.org/pdf/2607.07767v1)

**Summary:** Missing values undermine statistical inference and machine learning pipelines, yet most imputation methods rely on heuristics or restrictive parametric assumptions that ignore the joint data distribution. We recast imputation under missing completely at random (MCAR) as density estimation from masked observations: estimate a distribution whose observed marginals exactly match those in the data. Leveraging positive semi definite (PSD) kernel densities we obtain a convex empirical risk problem wit...

---

### 18. Avoiding unsafe sets when training with Langevin Dynamics
...
### 19. A Unified Detection Framework for AI-Related Content and Artifacts
...
### 20. Fast Rates for Semi-Supervised Learning via Data-Augmentation Graph Regularization
...
### 21. Statistical inverse learning and $\ell^1$-regularization
...
### 22. The Optimal Sample Complexity of Learning Autoregressive Chain-of-Thought
...
### 23. DiPhon: Diffusion on Graphons for Scalable Graph Generation
...
### 24. LiST: Lipschitz Scaling Training for Robust and Calibrated Neural Networks

**Authors:** Arthur Chiron, Franck Mamalet, Thomas Massena, et al.

**Published:** 2026-07-08

🔗 [Paper](http://arxiv.org/abs/2607.07745v1) | 📄 [PDF](https://arxiv.org/pdf/2607.07745v1)

**Summary:** While accuracy, robustness, and calibration are all essential for reliable neural networks, they are often studied separately; developing models that satisfy all three simultaneously remains a central challenge. Lipschitz-constrained models guarantee robustness by design, yet the manual selection of the Lipschitz constraint L governs the resulting accuracy-robustness trade-off, and their calibration properties remain largely underexplored. In this work, we highlight a theoretical and empirical l...

---

### 25. Gauge-Invariant Learnable Spectral Positional Encodings for Directed Graphs via Hermitian Block Krylov Subspaces
...
### 26. Local large deviations for linear-region growth in random piecewise-linear networks
...
### 27. Tensorized algorithms and scalable filtering methods for hidden Markov and factorial hidden Markov models
...
### 28. Transfer Learning for Linear Discriminant Analysis with a Shared Classification Signal
...
### 29. Mathematical methods of reinforcement learning

**Authors:** Denis Belomestny, Alexander Gasnikov, Egor Gladin, et al.

**Published:** 2026-07-08

🔗 [Paper](http://arxiv.org/abs/2607.06935v1) | 📄 [PDF](https://arxiv.org/pdf/2607.06935v1)
...
### 30. Finding a stationary point of a stochastic convex problem
...
### 31. Best-Arm Identification with Generative Proxy
...
### 32. Tensor Train Diffusion: Leveraging Low-Rank Structures for High-Dimensional Score-Based Sampling
...
### 33. Heat-Kernel Entropy Profiles and Geometric Effective Sample Size for Weighted Measures on Manifolds
...
### 34. From Jumps to Signatures: a Generative Method for Temporal Point Processes
...
### 35. EntroPath: Maximum Entropy Path Ensemble Embedding for Manifold Learning
...
### 36. Fast determinantal sampling on general spaces and diffusion geometry
...
### 37. A Function-Space Dichotomy for Compositional Learning: Exponential Sub-Optimality of the Neural Tangent Kernel
...
### 38. Feature Learning for the High Dimensional Stationary Schödinger Equation with Deep Ritz Method
...
### 39. Factor-Augmented Machine Learning Panel Regressions
...
### 40. Approximate Risk Minimization Over Shrinking-Thresholding Rules in Normal Mean Estimation
...
### 41. A unified perspective of Gaussian process approximation for differential equations
...
### 42. Quantitative Gaussian-Process limits of Tensor Programs
...
### 43. The Regularization Parameter: Sparse Precision Matrix Estimation

**Authors:** Aryan Eftekhari, Daniel Sergio Vega, Ernst-Jan Camiel Wit, et al.

**Published:** 2026-07-07

🔗 [Paper](http://arxiv.org/abs/2607.07735v1) | 📄 [PDF](https://arxiv.org/pdf/2607.07735v1)

**Summary:** Sparse precision matrix estimation provides an interpretable and computationally efficient framework for modeling conditional dependencies in high-dimensional, low-sample-size data. A recurring challenge is appropriately selecting the regularization parameter that controls estimator sparsity and strikes a balance between underfitting and overfitting. We propose a closed-form, matrix-valued regularization parameter derived from the sampling distribution of the first-order optimality conditions of...

---

### 44. A Convex Approximation Framework for Neural Likelihood-Based Bayesian Inverse Problems
...
### 45. Closed-form fractional radial links for elliptical Mahalanobis discriminant analysis
...
### 46. Separation Capacity of Scattering Networks on Low-Dimensional Datasets
...
### 47. Stochastic generator of trajectories from record data: application to the fluctuations of a glacier's frontal position from a sample of moraines
...
### 48. On the convergence of graph Laplacians with a symmetric divergence
...
### 49. No Subspace to Track: Non-Identifiability and Optimizer State in Low-Rank Training
...
### 50. A Quiet Failure in Calibrated Virtual Screening: Marginal Conformal Prediction Under-Covers the Minority Class, and a Class-Conditional Fix Recovers It
